...
<div class="bg-gradient-to-br from-pink-50 to-purple-50 p-6 rounded-2xl shadow-lg border border-pink-100">
    ...
    <form action="{{ route('pegawai.books.store') }}" method="POST" enctype="multipart/form-data" class="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-purple-100">
        @csrf
